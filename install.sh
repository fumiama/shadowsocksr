...
shadowsocks_r_file="shadowsocksr-main"
shadowsocks_r_url="https://github.com/fumiama/shadowsocksr/archive/main.tar.gz"
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo -e "Your Protocol         : \033[41;37m ${shadowsockprotocol} \033[0m"        echo -e "Your obfs             : \033[41;37m ${shadowsockobfs} \033[0m"
